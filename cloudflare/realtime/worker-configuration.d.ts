/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml cloudflare/realtime/worker-configuration.d.ts` (hash: d1967ac24e15320b2d9e2d4aa9ba8bd1)
// Runtime types generated with workerd@1.20260710.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	FABRIC_ENV: "local" | "production";
	REALTIME_ALLOWED_ORIGINS: "http://localhost:3000" | "https://fabric-rose-iota.vercel.app";
	REALTIME_ISSUER: "fabric-web";
	REALTIME_AUDIENCE: "fabric-realtime";
	REALTIME_TICKET_SIGNING_KEY: string;
	REALTIME_COORDINATOR_SECRET: string;
	FABRIC_BOARD_ROOMS: DurableObjectNamespace<import("./worker").FabricBoardRoom>;
	FABRIC_ACCESS_COORDINATORS: DurableObjectNamespace<import("./worker").WorkspaceAccessCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "FabricBoardRoom" | "WorkspaceAccessCoordinator";
	}
	interface DevEnv {
		FABRIC_ENV: "local";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FABRIC_ENV" | "REALTIME_ALLOWED_ORIGINS" | "REALTIME_ISSUER" | "REALTIME_AUDIENCE" | "REALTIME_TICKET_SIGNING_KEY" | "REALTIME_COORDINATOR_SECRET">> {}
}
