/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml cloudflare/realtime/worker-configuration.d.ts` (hash: 76fd2a5a0e02fb64f7ddab076c357836)
// Runtime types generated with workerd@1.20260710.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	FABRIC_ENV: "local" | "production";
	REALTIME_ALLOWED_ORIGINS: "http://localhost:3000" | "https://fabric-athrix.vercel.app";
