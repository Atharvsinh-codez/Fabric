/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml cloudflare/realtime/worker-configuration.d.ts` (hash: 60c90fdb1a30b0eb9b857662899752a0)
// Runtime types generated with workerd@1.20260710.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	FABRIC_ENV: "local" | "production";
	REALTIME_ALLOWED_ORIGINS: "http://localhost:3000" | "https://fabric-s9rn.vercel.app";
