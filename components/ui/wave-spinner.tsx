...
/**
 * Adapted from GAIA UI's MIT-licensed Wave Spinner:
 * https://ui.heygaia.io/docs/components/wave-spinner
 *
...
export const WaveSpinner: FC<WaveSpinnerProps> = ({
  ...
  return (
    <div
      className={cn("wave-spinner", waveSpinnerVariants({ size }), className)}
      role="status"
